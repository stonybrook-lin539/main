...
(A brief aside: based on the discussion above, we can infer that $G_1 \cup G_2$ isn't necessarily the smallest negative grammar that generates $L(G_1 \cup G_2)$.
