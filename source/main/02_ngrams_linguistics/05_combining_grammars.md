...
::: exercise
Write two negative grammars with alphabet $\setof{a,b}$ such that the first only generates *ab* and *ba*, whereas the latter generates all strings of the form *ab*, *aab*, *aaab*, and so on.
...
1. **Lemma for combining negative grammars**: $L(N(\overline{G_1} \cup \overline{G_2}))$
