...
- the first only generates *ab*, *abb*, *abbb*, and so on, and
- the latter generates all strings of the form *ab*, *aab*, *aaab*, and so on.
...
- the first only generates *ab*, *ab* and *ba*,
- the latter generates all strings of the form *ab*, *aab*, *aaab*, and so on.
...
- the first contains all strings except those that start with *c* or end in *c*,
- the latter generates all strings of the form $b^* a^+ c^*$, i.e. 0 or more *b*s followed by 1 or more *a*s, followed by 0 or more *c*s.
